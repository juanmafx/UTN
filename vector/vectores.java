...
EJERCICIO CON USO DE CICLOS Y ARREGLOS
Realizar un programa que permita cargar 10 nros. enteros  y luego presente un menú con las siguientes opciones;
Mostrar la SUMA DE LOS NÚMEROS
Realizar y mostrar el producto de todos los números
Calcular el promedio y mostrarlo
Buscar y mostrar el  mayor de los números
Buscar y mostrar el menor de los números
 2) Observatorio meteorológico
...
El usuario debe ingresar cuantas mediciones realizó y  los  valores de temperatura (considerar que son valores enteros). 
...
 4) Institución Educativa
     ...
     Los requerimientos funcionales son:
    a)      Código de identificación de curso que menos alumnos inscriptos.
   b)      Porcentaje de niñas de cada curso.
   c)       Porcentaje de niños de cada curso.
  d)      Promedio general de alumnos.
   e)      Si algunos de los tres grados supera el cupo máximo informar un mensaje la      
